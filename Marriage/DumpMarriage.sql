...
--
-- Table structure for table `multiuploads`
--

DROP TABLE IF EXISTS `multiuploads`;
...
--
-- Dumping data for table `multiuploads`
--

LOCK TABLES `multiuploads` WRITE;
/*!40000 ALTER TABLE `multiuploads` DISABLE KEYS */;
INSERT INTO `multiuploads` VALUES (1,'dsfsdfsaf',NULL,NULL,NULL),(2,'dsfsdfsaf',0,0,NULL),(3,'dsfsdfsaf',0,0,NULL),(4,'my Profile',0,0,0),(5,'my Pic',0,0,0),(6,'my Pic',0,0,0);
/*!40000 ALTER TABLE `multiuploads` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `agent_master` VALUES (2,'sujata','45321','sujata25@gmail.com','kolhapur','pune',1,'9874561236'),(3,'ssss','12345','suraj@gmail.com','satara','satara',1,'123456789');
...
CREATE TABLE `members` (
  ...
  KEY `agentmasterid` (`agentid`),
  CONSTRAINT `agentmasterid` FOREIGN KEY (`agentid`) REFERENCES `agent_master` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `members` VALUES (10,3,'dsasdsd','asdasd','asdsda','sasds','Just Curious','NO Fixed Time','M',1,'2014-04-05','02:50:00','1234567890',1,'00:00:00','dsfsdf',2,217,3,335,'adds','Yes','Yes',0,1,0,1,2,52,'kolhapur','asdsad',0,0,'Work Visa',NULL,288,323,342,364,NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,'Don\'t',199,3,'Traditional',1,'dsfsf','sujata25@gmail.com',0,0,'12345',1,NULL),(11,3,'Suresh','Mahadev','Patil','Suresh','Just Curious','Within 12 Months','Male',1,'1988-06-15','02:30:00','9256897415',1,'10:00:00','9856741235',2,225,3,336,'Father','Yes','Yes',0,1,0,1,2,52,'Kolhapur','Kagal',0,0,'Work Visa',NULL,288,323,356,379,NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,'No',199,3,'Traditional',1,'bncvn','suresh@gmail.com',0,0,'suresh',1,NULL),(17,3,'Prashant','Sambhaji ','Jadhav','Prashant','Just Curious','NO Fixed Time','Male',1,'1988-10-15','04:30:00','9955864875',1,'10:00:00','9745861245',2,219,3,336,'Father','Yes','Yes',0,0,0,0,2,52,'Satara','Koregaov',0,0,'Work Visa',NULL,288,323,354,379,NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,'No',199,3,'Traditional',1,'bncvn','prashant12@gmail.com',0,0,'56789',1,NULL),(18,3,'abcd','pqrs','xyz','ABCD','Just Curious','NO Fixed Time','Male',1,'1988-10-15','04:30:00','9256897415',1,'10:00:00','9745861245',2,226,2,337,'Father','Yes','Yes',0,1,0,0,2,52,'Satara','karad',0,0,'Work Visa',NULL,288,323,354,375,NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,'No',199,3,'Traditional',1,'bncvn','abcd@gmail.com',0,0,'12345',1,NULL),(19,2,'sss','ddd','yyy','sss','Just Curious','Within 12 Months','Male',1,'1988-01-04','02:50:00','1234567890',1,'10:00:00','dsfsdf',3,225,3,336,'adds','Yes','Yes',0,1,0,0,2,52,'kolhapur','asdsad',0,0,'Work Visa',NULL,288,323,357,382,NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,'No',199,3,'Traditional',1,'dsfsf','rahulvijay4493@gmail.com',0,0,'1234',1,NULL),(20,3,'Ravi','Bhimrao','Salunkhe','Ravi','Just Curious','Within 12 Months','Male',1,'1988-01-04','04:50:00','1234567890',1,'10:00:00','dsfsdf',3,225,2,337,'father','Yes','Yes',0,1,0,0,2,52,'kolhapur','kagal',0,0,'Work Visa',NULL,288,323,356,380,NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,'No',199,3,'Traditional',1,'dsfsf','rahulvijay4493@gmail.com',0,0,'123456',1,NULL),(21,3,'Ravi','Bhimrao','Salunkhe','Ravi','Just Curious','NO Fixed Time','Male',1,'1988-01-06','04:50:00','1234567890',1,'10:00:00','dsfsdf',3,225,3,336,'father','Yes','Yes',0,1,0,0,2,52,'kolhapur','kagal',0,0,'Work Visa',NULL,288,323,356,378,NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,'No',199,3,'Traditional',1,'dsfsf','ravi@gmail.com',0,0,'45',1,NULL),(22,3,'Somesh','Vinayak','Kumbahr','Somesh','Just Curious','Within 12 Months','Male',1,'0001-01-01','04:50:00','1234567890',1,'10:00:00','dsfsdf',3,225,3,336,'father','Yes','Yes',0,1,0,0,2,52,'kolhapur','kagal',0,0,'Work Visa',NULL,288,323,357,379,NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,'No',199,3,'Traditional',1,'dsfsf','somesh@gmail.com',0,0,'4567',1,NULL),(23,3,'sunil','balaso','nikam','sunil','Relationship','Within 12 Months','Male',1,'0001-01-01','04:50:00','1234567890',1,'10:00:00','dsfsdf',3,225,2,336,'father','Yes','Yes',0,1,0,0,2,52,'kolhapur','kagal',0,0,'Work Visa',NULL,288,323,357,378,NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,'No',199,3,'Traditional',1,'dsfsf','sunil@gmail.com',0,0,'pqrs',1,NULL),(24,4,'xyz','pqr','lmn','xyz','Just Curious','Within 12 Months','Male',1,'1992-01-04','04:50:00','1234567890',1,'10:00:00','dsfsdf',3,232,2,335,'father','Yes','Yes',0,1,0,0,2,52,'kolhapur','kagal',0,0,'Work Visa',NULL,288,323,355,382,NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,'No',199,3,'Traditional',1,'dsfsf','xyz@gmail.com',0,0,'112233',1,NULL),(25,3,'xyz','pqr','lmn','xyz','Just Curious','Within 12 Months','Male',1,'1992-01-04','04:50:00','1234567890',1,'10:00:00','dsfsdf',3,232,2,336,'father','Yes','Yes',0,1,0,0,2,52,'kolhapur','kagal',0,0,'Work Visa',NULL,288,323,356,382,NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,'No',199,3,'Traditional',1,'dsfsf','xyz@gmail.com',0,0,'112233',1,NULL);
...
-- Dump completed on 2014-06-30 13:29:03
